...
export const NavbarClient = ({ user, initials, avatarUrl }: NavbarClientProps) => {
  ...
  return (
    <>
      ...
      {isMobileMenuOpen && (
        <div
          className="fixed inset-0 bg-[#081b2e]/60 backdrop-blur-sm z-[55] md:hidden"
          onClick={closeMenu}
          aria-hidden="true"
        />
      )}
      ...
      {isMobileMenuOpen && (
        <div className="lb-global-nav__drawer fixed top-0 right-0 h-full w-[80vw] max-w-[320px] bg-[#0b2540] border-l border-white/10 shadow-2xl z-[55] flex flex-col md:hidden">
